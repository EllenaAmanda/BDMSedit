...
<body>
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-4 mb-3">Perlu Darah</h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Alasan memerlukan darah<span style="color:red">*</span></div>
<div><textarea class="form-control" name="address" required></textarea></div></div>
</div>
<div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="search" class="btn btn-primary" value="Cari" style="cursor:pointer"></div>
</div>
